...
HX_DEFINE_STACK_FRAME(_hx_pos_6b3fe25948ba01a2_12_new,"haxe.MainEvent","new",0x1c640c2b,"haxe.MainEvent.new","C:\\HaxeToolkit\\haxe\\std/haxe/MainLoop.hx",12,0x949ef6b1)
namespace haxe{

void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_STACKFRAME(&_hx_pos_6b3fe25948ba01a2_12_new)
HXLINE(  13)		this->f = f;
