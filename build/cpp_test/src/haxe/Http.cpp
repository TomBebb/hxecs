...
HX_LOCAL_STACK_FRAME(_hx_pos_fedd768dee4a1715_103_setHeader,"haxe.Http","setHeader",0x34bd0dd1,"haxe.Http.setHeader","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",103,0xd46eaf46)
HX_LOCAL_STACK_FRAME(_hx_pos_fedd768dee4a1715_102_setHeader,"haxe.Http","setHeader",0x34bd0dd1,"haxe.Http.setHeader","C:\\HaxeToolkit\\haxe\\std/haxe/Http.hx",102,0xd46eaf46)
...
bool Http_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::Http Http_obj::setHeader(::String header,::String value){
            		...
            		bool _hx_run( ::Dynamic h){
            			HX_STACKFRAME(&_hx_pos_fedd768dee4a1715_103_setHeader)
HXLINE( 103)			return (( (::String)(h->__Field(HX_("header",8d,09,00,fd),hx::paccDynamic)) ) != header);
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_fedd768dee4a1715_102_setHeader)
