...
HX_DEFINE_STACK_FRAME(_hx_pos_d34aa48591214e44_262_new,"massive.munit.client.URLRequest","new",0xe54fb6ae,"massive.munit.client.URLRequest.new","massive/munit/client/HTTPClient.hx",262,0xff13f150)
HX_LOCAL_STACK_FRAME(_hx_pos_d34aa48591214e44_271_createClient,"massive.munit.client.URLRequest","createClient",0xceacea59,"massive.munit.client.URLRequest.createClient","massive/munit/client/HTTPClient.hx",271,0xff13f150)
HX_LOCAL_STACK_FRAME(_hx_pos_d34aa48591214e44_280_setHeader,"massive.munit.client.URLRequest","setHeader",0xa41e139d,"massive.munit.client.URLRequest.setHeader","massive/munit/client/HTTPClient.hx",280,0xff13f150)
HX_LOCAL_STACK_FRAME(_hx_pos_d34aa48591214e44_287_send,"massive.munit.client.URLRequest","send",0xc3be2b3a,"massive.munit.client.URLRequest.send","massive/munit/client/HTTPClient.hx",287,0xff13f150)
namespace massive{
namespace munit{
namespace client{

void URLRequest_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d34aa48591214e44_262_new)
HXLINE( 263)		this->url = url;
HXLINE( 264)		this->createClient(url);
HXLINE( 265)		this->setHeader(HX_("Content-Type",ce,69,5d,3c),HX_("text/plain",e8,fb,af,91));
            	}
...
bool URLRequest_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x04bc6c58;
}

void URLRequest_obj::createClient(::String url){
            	HX_GC_STACKFRAME(&_hx_pos_d34aa48591214e44_271_createClient)
HXDLIN( 271)		this->client =  ::haxe::Http_obj::__alloc( HX_CTX ,url);
            	}
...
void URLRequest_obj::setHeader(::String name,::String value){
            	HX_STACKFRAME(&_hx_pos_d34aa48591214e44_280_setHeader)
HXDLIN( 280)		this->client->setHeader(name,value);
            	}
...
void URLRequest_obj::send(){
            	HX_STACKFRAME(&_hx_pos_d34aa48591214e44_287_send)
HXLINE( 288)		::String body = ::Std_obj::string(this->data);
HXLINE( 290)		this->client->onData = this->onData;
HXLINE( 291)		this->client->onError = this->onError;
HXLINE( 298)		this->client->setParameter(HX_("data",2a,56,63,42),body);
HXLINE( 301)		this->client->request(true);
            	}
...
hx::ObjectPtr< URLRequest_obj > URLRequest_obj::__alloc(hx::Ctx *_hx_ctx,::String url) {
	URLRequest_obj *__this = (URLRequest_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(URLRequest_obj), true, "massive.munit.client.URLRequest"));
