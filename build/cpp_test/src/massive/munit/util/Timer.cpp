...
HX_DEFINE_STACK_FRAME(_hx_pos_3d46db1a832aafda_91_new,"massive.munit.util.Timer","new",0xa904eb52,"massive.munit.util.Timer.new","massive/munit/util/Timer.hx",91,0xdb7ac55d)
HX_DEFINE_STACK_FRAME(_hx_pos_3d46db1a832aafda_81_new,"massive.munit.util.Timer","new",0xa904eb52,"massive.munit.util.Timer.new","massive/munit/util/Timer.hx",81,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_113_stop,"massive.munit.util.Timer","stop",0x3ea268d0,"massive.munit.util.Timer.stop","massive/munit/util/Timer.hx",113,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_96_stop,"massive.munit.util.Timer","stop",0x3ea268d0,"massive.munit.util.Timer.stop","massive/munit/util/Timer.hx",96,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_119___default_run,"massive.munit.util.Timer","__default_run",0xa79737df,"massive.munit.util.Timer.__default_run","massive/munit/util/Timer.hx",119,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_123_runLoop,"massive.munit.util.Timer","runLoop",0xec333741,"massive.munit.util.Timer.runLoop","massive/munit/util/Timer.hx",123,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_147_delay,"massive.munit.util.Timer","delay",0xe28a12f5,"massive.munit.util.Timer.delay","massive/munit/util/Timer.hx",147,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_144_delay,"massive.munit.util.Timer","delay",0xe28a12f5,"massive.munit.util.Timer.delay","massive/munit/util/Timer.hx",144,0xdb7ac55d)
HX_LOCAL_STACK_FRAME(_hx_pos_3d46db1a832aafda_161_stamp,"massive.munit.util.Timer","stamp",0x8f6eab75,"massive.munit.util.Timer.stamp","massive/munit/util/Timer.hx",161,0xdb7ac55d)
namespace massive{
namespace munit{
namespace util{

void Timer_obj::__construct(int time_ms){
            		HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_hx_Closure_0, ::Dynamic,f,int,a1) HXARGC(0)
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_91_new)
HXLINE(  91)			f(a1);
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_81_new)
HXLINE(  90)		 ::massive::munit::util::Timer me = hx::ObjectPtr<OBJ_>(this);
HXLINE(  91)		 ::Dynamic f = me->runLoop_dyn();
HXDLIN(  91)		int a1 = time_ms;
HXDLIN(  91)		this->runThread = ::cpp::vm::Thread_obj::create( ::Dynamic(new _hx_Closure_0(f,a1)));
            	}
...
bool Timer_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0c869892;
}

void Timer_obj::stop(){
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		void _hx_run(){
            			HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_113_stop)
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_96_stop)
HXLINE( 113)		this->run =  ::Dynamic(new _hx_Closure_0());
HXLINE( 114)		this->runThread->sendMessage(HX_("stop",02,f0,5b,4c));
HXLINE( 116)		this->id = null();
            	}
...
void _hx_run(){
            	HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_119___default_run)
            	}
HX_END_LOCAL_FUNC0((void))
HX_END_DEFAULT_FUNC

void Timer_obj::runLoop(int time_ms){
            	HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_123_runLoop)
HXLINE( 124)		bool shouldStop = false;
HXLINE( 125)		while(!(shouldStop)){
HXLINE( 127)			::Sys_obj::sleep(((Float)time_ms / (Float)(int)1000));
HXLINE( 128)			try {
...
HXLINE( 130)				this->run();
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic ex = _hx_e;
HXLINE( 134)					::haxe::Log_obj::trace(ex,hx::SourceInfo(HX_("Timer.hx",39,a8,b7,da),134,HX_("massive.munit.util.Timer",60,9a,7c,a0),HX_("runLoop",4f,bb,f4,d4)));
            				}
            				else {
            					HX_STACK_DO_THROW(_hx_e);
            				}
            			}
HXLINE( 137)			::String msg = ( (::String)(::cpp::vm::Thread_obj::readMessage(false)) );
HXLINE( 138)			if ((msg == HX_("stop",02,f0,5b,4c))) {
HXLINE( 138)				shouldStop = true;
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Timer_obj,runLoop,(void))
 ...
 ::massive::munit::util::Timer Timer_obj::delay( ::Dynamic f,int time_ms){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_3d46db1a832aafda_147_delay)
HXLINE( 148)			t->stop();
HXLINE( 149)			f();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_3d46db1a832aafda_144_delay)
HXLINE( 145)		 ::massive::munit::util::Timer t =  ::massive::munit::util::Timer_obj::__alloc( HX_CTX ,time_ms);
HXLINE( 146)		t->run =  ::Dynamic(new _hx_Closure_0(f,t));
HXLINE( 151)		return t;
            	}
...
Float Timer_obj::stamp(){
            	HX_STACKFRAME(&_hx_pos_3d46db1a832aafda_161_stamp)
HXDLIN( 161)		return ::__time_stamp();
            	}
...
hx::ObjectPtr< Timer_obj > Timer_obj::__alloc(hx::Ctx *_hx_ctx,int time_ms) {
	Timer_obj *__this = (Timer_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(Timer_obj), true, "massive.munit.util.Timer"));
	*(void **)__this = Timer_obj::_hx_vtable;
	massive::munit::util::Timer_obj::__alloc_dynamic_functions(_hx_ctx,__this);
	__this->__construct(time_ms);
	return __this;
}
