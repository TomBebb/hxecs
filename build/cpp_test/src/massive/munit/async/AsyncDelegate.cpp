...
HX_DEFINE_STACK_FRAME(_hx_pos_a123a0a30ee672de_43_new,"massive.munit.async.AsyncDelegate","new",0xd27a25ba,"massive.munit.async.AsyncDelegate.new","massive/munit/async/AsyncDelegate.hx",43,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_107_runTest,"massive.munit.async.AsyncDelegate","runTest",0x98bbe797,"massive.munit.async.AsyncDelegate.runTest","massive/munit/async/AsyncDelegate.hx",107,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_114_cancelTest,"massive.munit.async.AsyncDelegate","cancelTest",0xf61e90d2,"massive.munit.async.AsyncDelegate.cancelTest","massive/munit/async/AsyncDelegate.hx",114,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_121_responseHandler,"massive.munit.async.AsyncDelegate","responseHandler",0x09155fa3,"massive.munit.async.AsyncDelegate.responseHandler","massive/munit/async/AsyncDelegate.hx",121,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_132_delayActualResponseHandler,"massive.munit.async.AsyncDelegate","delayActualResponseHandler",0x12ec55be,"massive.munit.async.AsyncDelegate.delayActualResponseHandler","massive/munit/async/AsyncDelegate.hx",132,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_143_timeoutHandler,"massive.munit.async.AsyncDelegate","timeoutHandler",0xcfad180f,"massive.munit.async.AsyncDelegate.timeoutHandler","massive/munit/async/AsyncDelegate.hx",143,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_148_actualTimeoutHandler,"massive.munit.async.AsyncDelegate","actualTimeoutHandler",0x6491c3bd,"massive.munit.async.AsyncDelegate.actualTimeoutHandler","massive/munit/async/AsyncDelegate.hx",148,0x9ad95939)
HX_LOCAL_STACK_FRAME(_hx_pos_a123a0a30ee672de_48_boot,"massive.munit.async.AsyncDelegate","boot",0x507fdd98,"massive.munit.async.AsyncDelegate.boot","massive/munit/async/AsyncDelegate.hx",48,0x9ad95939)
namespace massive{
namespace munit{
namespace async{

void AsyncDelegate_obj::__construct( ::Dynamic testCase, ::Dynamic handler, ::Dynamic timeout, ::Dynamic info){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_43_new)
HXLINE(  80)		this->params = ::cpp::VirtualArray_obj::__new(0);
HXLINE(  70)		this->canceled = false;
HXLINE(  69)		this->timedOut = false;
HXLINE(  92)		this->testCase = testCase;
HXLINE(  93)		this->handler = handler;
HXLINE(  94)		this->delegateHandler = ::Reflect_obj::makeVarArgs(this->responseHandler_dyn());
HXLINE(  95)		this->info = info;
HXLINE(  96)		bool _hx_tmp;
HXDLIN(  96)		if (hx::IsNotNull( timeout )) {
HXLINE(  96)			_hx_tmp = hx::IsLessEq( timeout,(int)0 );
            		}
            		else {
HXLINE(  96)			_hx_tmp = true;
            		}
HXDLIN(  96)		if (_hx_tmp) {
HXLINE(  96)			timeout = (int)400;
            		}
HXLINE(  97)		this->timeoutDelay = timeout;
HXLINE(  98)		this->timer = ::massive::munit::util::Timer_obj::delay(this->timeoutHandler_dyn(),this->timeoutDelay);
            	}

Dynamic AsyncDelegate_obj::__CreateEmpty() { return new AsyncDelegate_obj; }

void *AsyncDelegate_obj::_hx_vtable = 0;
...
bool AsyncDelegate_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x14d95d1a;
}

void AsyncDelegate_obj::runTest(){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_107_runTest)
HXDLIN( 107)		::Reflect_obj::callMethod(this->testCase,this->handler,this->params);
            	}
...
void AsyncDelegate_obj::cancelTest(){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_114_cancelTest)
HXLINE( 115)		this->canceled = true;
HXLINE( 116)		this->timer->stop();
HXLINE( 117)		if (hx::IsNotNull( this->deferredTimer )) {
HXLINE( 117)			this->deferredTimer->stop();
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AsyncDelegate_obj,cancelTest,(void))
 ...
 ::Dynamic AsyncDelegate_obj::responseHandler(::cpp::VirtualArray params){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_121_responseHandler)
HXLINE( 122)		bool _hx_tmp;
HXDLIN( 122)		if (!(this->timedOut)) {
HXLINE( 122)			_hx_tmp = this->canceled;
            		}
            		else {
...
HXLINE( 123)		this->timer->stop();
HXLINE( 124)		if (hx::IsNotNull( this->deferredTimer )) {
HXLINE( 124)			this->deferredTimer->stop();
            		}
HXLINE( 125)		::cpp::VirtualArray _hx_tmp1;
HXDLIN( 125)		if (hx::IsNotNull( params )) {
HXLINE( 125)			_hx_tmp1 = params->copy();
            		}
            		else {
HXLINE( 125)			_hx_tmp1 = ::cpp::VirtualArray_obj::__new(0);
            		}
HXDLIN( 125)		this->params = _hx_tmp1;
HXLINE( 127)		if (hx::IsNotNull( this->observer )) {
HXLINE( 127)			::massive::munit::util::Timer_obj::delay(this->delayActualResponseHandler_dyn(),(int)1);
            		}
...
void AsyncDelegate_obj::delayActualResponseHandler(){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_132_delayActualResponseHandler)
HXLINE( 133)		::massive::munit::async::IAsyncDelegateObserver_obj::asyncResponseHandler(this->observer,hx::ObjectPtr<OBJ_>(this));
HXLINE( 134)		this->observer = null();
            	}
...
void AsyncDelegate_obj::timeoutHandler(){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_143_timeoutHandler)
HXDLIN( 143)		this->actualTimeoutHandler();
            	}
...
void AsyncDelegate_obj::actualTimeoutHandler(){
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_148_actualTimeoutHandler)
HXLINE( 149)		this->deferredTimer = null();
HXLINE( 150)		this->handler = null();
HXLINE( 151)		this->delegateHandler = null();
HXLINE( 152)		this->timedOut = true;
HXLINE( 153)		if (hx::IsNotNull( this->observer )) {
HXLINE( 155)			::massive::munit::async::IAsyncDelegateObserver_obj::asyncTimeoutHandler(this->observer,hx::ObjectPtr<OBJ_>(this));
HXLINE( 156)			this->observer = null();
            		}
            	}
...
hx::ObjectPtr< AsyncDelegate_obj > AsyncDelegate_obj::__new( ::Dynamic testCase, ::Dynamic handler, ::Dynamic timeout, ::Dynamic info) {
	hx::ObjectPtr< AsyncDelegate_obj > __this = new AsyncDelegate_obj();
	__this->__construct(testCase,handler,timeout,info);
	return __this;
}

hx::ObjectPtr< AsyncDelegate_obj > AsyncDelegate_obj::__alloc(hx::Ctx *_hx_ctx, ::Dynamic testCase, ::Dynamic handler, ::Dynamic timeout, ::Dynamic info) {
	AsyncDelegate_obj *__this = (AsyncDelegate_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(AsyncDelegate_obj), true, "massive.munit.async.AsyncDelegate"));
	*(void **)__this = AsyncDelegate_obj::_hx_vtable;
	__this->__construct(testCase,handler,timeout,info);
	return __this;
}
...
{
	hx::Object *dummy = new AsyncDelegate_obj;
	AsyncDelegate_obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_a123a0a30ee672de_48_boot)
HXDLIN(  48)		DEFAULT_TIMEOUT = (int)400;
            	}
}
