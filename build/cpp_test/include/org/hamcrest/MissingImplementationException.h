...
class HXCPP_CLASS_ATTRIBUTES MissingImplementationException_obj : public  ::org::hamcrest::Exception_obj
{
	...
	public:
		...
		static hx::ObjectPtr< MissingImplementationException_obj > __alloc(hx::Ctx *_hx_ctx,::String __o_message, ::Dynamic cause, ::Dynamic info);
