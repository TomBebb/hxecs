...
ExampleTest.prototype = {
	...
	,testAsyncExample: function(factory) {
		var handler = factory.createHandler(this,$bind(this,this.onTestAsyncExampleComplete),300,{ fileName : "ExampleTest.hx", lineNumber : 47, className : "ExampleTest", methodName : "testAsyncExample"});
		var timer = massive_munit_util_Timer.delay(handler,200);
	}
	,onTestAsyncExampleComplete: function() {
		massive_munit_Assert.isFalse(false,null,{ fileName : "ExampleTest.hx", lineNumber : 53, className : "ExampleTest", methodName : "onTestAsyncExampleComplete"});
	}
	,testExampleThatOnlyRunsWithDebugFlag: function() {
		massive_munit_Assert.isTrue(true,null,{ fileName : "ExampleTest.hx", lineNumber : 62, className : "ExampleTest", methodName : "testExampleThatOnlyRunsWithDebugFlag"});
	}
